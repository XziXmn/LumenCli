...
All keyboard shortcuts can be customized via `~/.lumen/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.lumen/agent/keybindings.json`:
