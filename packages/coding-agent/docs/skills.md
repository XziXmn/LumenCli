...
Discovery rules:
- In `~/.lumen/agent/skills/` and `.lumen/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.lumen/settings.json`:
