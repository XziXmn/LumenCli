...
Sessions are saved automatically to `~/.lumen/agent/sessions/`, organized by working directory.
...
- `~/.lumen/agent/AGENTS.md` for global instructions
...
- `.lumen/SYSTEM.md` for a project
- `~/.lumen/agent/SYSTEM.md` globally
...
|----------|-------------|
| `LUMEN_CODING_AGENT_DIR` | Override config directory; default is `~/.lumen/agent` |
| `LUMEN_CODING_AGENT_SESSION_DIR` | Override session storage directory; overridden by `--session-dir` |
