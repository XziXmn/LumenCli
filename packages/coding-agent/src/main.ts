...
import { declineLegacyPiImport, detectLegacyPiImport, importLegacyPiConfig } from "./legacy-pi-import.ts";
...
export async function main(args: string[], options?: MainOptions) {
	...
	const offlineMode =
		...
		isTruthyEnvFlag(process.env.LUMEN_OFFLINE) ||
		isTruthyEnvFlag(process.env.PI_OFFLINE);
	if (offlineMode) {
		process.env.LUMEN_OFFLINE = "1";
