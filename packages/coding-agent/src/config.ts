...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/earendil-works/pi-mono/releases/latest (or build from source)`;
	}
	const command = getSelfUpdateCommandForMethod(method, packageName, updatePackageName, npmCommand);
	if (command) {
...
export function getPackageDir(): string {
	...
	const envDir = process.env.LUMEN_PACKAGE_DIR || process.env.PI_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json lumenConfig)
// =============================================================================
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.LUMEN_SHARE_VIEWER_URL || process.env.PI_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
